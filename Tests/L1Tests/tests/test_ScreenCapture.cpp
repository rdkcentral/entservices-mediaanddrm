...
{   
    ...
    EXPECT_EQ(Core::ERROR_NONE, EVENT_SUBSCRIBE(0, _T("uploadComplete"), _T("org.rdk.ScreenCapture"), message));
    ...
    EXPECT_EQ(Core::ERROR_NONE, EVENT_UNSUBSCRIBE(0, _T("uploadComplete"), _T("org.rdk.ScreenCapture"), message));
