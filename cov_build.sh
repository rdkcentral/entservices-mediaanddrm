...
git clone https://github.com/rdkcentral/entservices-mediaanddrm.git
...
###########################################################
# Build entservices-mediaanddrm
echo "======================================================================================"
echo "buliding entservices-mediaanddrm"
cd $GITHUB_WORKSPACE
ls -al
cmake -G Ninja -S entservices-mediaanddrm -B build/entservices-mediaanddrm \
  -DUSE_THUNDER_R4=ON \
  -DCMAKE_INSTALL_PREFIX="$GITHUB_WORKSPACE/install/usr" \
  -DCMAKE_MODULE_PATH="$GITHUB_WORKSPACE/install/tools/cmake" \
