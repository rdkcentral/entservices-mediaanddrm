    ...
    namespace Plugin {
        class UnifiedCASManagementImplementation : public Exchange::IUnifiedCASManagement {
            public:
                ...
                static UnifiedCASManagementImplementation* instance(UnifiedCASManagementImplementation *unifiedCASImpl = nullptr);
            ...
            public:
                ...
                Core::hresult Unmanage(Exchange::IUnifiedCASManagement::SuccessResult& successResult) override;
                Core::hresult Send(const string& payload, const string& source, Exchange::IUnifiedCASManagement::SuccessResult& successResult) override;
                //End methods

                // Event notification method - fires data events to registered COM-RPC clients
                void event_data(const string& payload, const string& source);

                static UnifiedCASManagementImplementation* _instance;
            ...
            private:
                mutable Core::CriticalSection m_adminLock;
                std::list<Exchange::IUnifiedCASManagement::INotification*> m_notifications;
