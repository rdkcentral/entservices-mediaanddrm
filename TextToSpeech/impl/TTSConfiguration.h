...
#define DEFAULT_UTTERANCE_RATE 1.0
#define DEFAULT_UTTERANCE_VOLUME 1.0
#define DEFAULT_UTTERANCE_PITCH 1.0
#define UNSPECIFIED_UTTERANCE_RATE -1.0
#define UNSPECIFIED_UTTERANCE_VOLUME -1.0
#define UNSPECIFIED_UTTERANCE_PITCH -1.0
#define MIN_UTTERANCE_RATE 0.1
#define MAX_UTTERANCE_RATE 10.0
#define MIN_UTTERANCE_PITCH 0.0
#define MAX_UTTERANCE_PITCH 2.0
#define MIN_UTTERANCE_VOLUME 0.0
#define MAX_UTTERANCE_VOLUME 1.0
