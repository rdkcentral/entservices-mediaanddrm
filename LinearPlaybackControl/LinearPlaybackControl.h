    ...
    namespace Plugin
    {
        ...
        private:
            ...
            public:
                ...
                void OnSpeedChanged(const int16_t speed, const uint8_t muxId) override
                {
                    syslog(LOG_INFO, "OnSpeedChanged: speed=%d, muxId=%d", speed, muxId);
                    Exchange::JLinearPlaybackControl::Event::OnSpeedChanged(_parent, speed, muxId);
                }
